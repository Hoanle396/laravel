            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class=" form">
                            <form class="cmxform form-horizontal " action="{{URL::to('Admin/update-news')}}" method="post" enctype="multipart/form-data" validate>
                                @csrf
                                <input type="hidden" name="id" value="{{$news->news_id}}">
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-3">Tiêu Đề</label>
                                    <div class="col-lg-6">
                                        <input class="input-lg m-bot15 form-control" name="name" minlength="2" value="{{$news->news_title}}" type="text" required="">
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="ccomment" class="control-label col-lg-3">Mô Tả</label>
                                    <div class="col-lg-6">
                                        <textarea class="form-control input-lg m-bot15" id="description" name="description"  style=" resize: none;" required="">{{$news->news_description}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
