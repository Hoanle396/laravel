            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class=" form">
                            <form class="cmxform form-horizontal " action="{{URL::to('Admin/add-news')}}" method="post" enctype="multipart/form-data" validate>
                                @csrf
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-3">Tiêu Đề</label>
                                    <div class="col-lg-6">
                                        <input class="input-lg m-bot15 form-control" name="name" minlength="2" type="text" required="">
                                    </div>
                                </div>
                                <div class="form-group ">
