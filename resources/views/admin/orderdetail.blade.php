    ...
    <section class="wrapper">
        <div class="row">
            ...
            <div class="col-md-5 order-md-1">
                <form class="needs-validation" action="{{URL::to('Admin/Order/update')}}" method="post">
                    {{csrf_field()}}
                    <div class="mb-3">
                        <label for="username">Code</label>
                        <input type="text" class="form-control" name="code" value="{{$user->oder_code}}" readonly required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="address2" name="address2" value="{{$user->oder_pay}}" readonly required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status" class="form-control" id="">
                            <option value="{{$user->oder_status}}" selected>{{$user->oder_status}}</option>
    ...
    <div class="modal fade" id="huydon" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{URL::to('Admin/Order/update')}}" method="post">
                    {{csrf_field()}}
                    <div class="modal-body">
                        <div class="form-group ">
                            <input type="hidden" name="email" value="{{$user->user_email}}" readonly required>
                            <input type="hidden" name="code" value="{{$user->oder_code}}" readonly required>
                            <div class="col-12">
